        ...
        slivers: [
          ...
          SliverAppBar(
            ...
            title: Row(
              children: [
                 Text(
                  '      Product Details', style: TextStyle(color: Colors.white, fontSize: 20.sp, fontWeight: FontWeight.bold),
                ),
                const Spacer(),
                InkWell(
                   ...
                   child: Padding(
                     ...
                     child: Row(
                       ...
                       const  Icon(Icons.timer_outlined,color: Colors.white,),
                         SizedBox(width: 10.w,),
                         Text('Flash Sale',style: TextStyle(color: Colors.white,fontSize:18.sp,fontWeight: FontWeight.bold),),
                      const Spacer(),
                         Text('9',style: TextStyle(color: Colors.white,fontSize:16.sp,fontWeight: FontWeight.bold),),
                        const SizedBox(width: 5,),
                         Text('Available',style: TextStyle(color: Colors.white,fontSize:16.sp,fontWeight: FontWeight.bold),),
                      ...
                      const Row(
                       ...
                       Row(
                         children:   [
                           ...
                           Text('\$250',
                               maxLines: 1,
                               overflow: TextOverflow.ellipsis, style: TextStyle(fontSize:16.sp,color: Colors.grey,decoration:TextDecoration.lineThrough  )),
                         const  Spacer(),
                           Text('(65)',style: TextStyle(color: Colors.grey,fontSize: 16.sp),)
                         ],
                       ),
                       const Divider(color: Colors.black54,),
                        Text('Detail Product',style: TextStyle(fontSize: 16.sp,fontWeight:FontWeight.bold,overflow: TextOverflow.ellipsis),),
                       ...
                       const DetailProductText(title: '(4) - Non Touch Bar'),
                        SizedBox(height: 10.h,),
                        Text('Description',style: TextStyle(fontSize: 16.sp,fontWeight:FontWeight.bold,overflow: TextOverflow.ellipsis),),
                        SizedBox(height: 5.h,),
                       ...
                       Row(
                         ...
                         children:   [
                           Text('Top Rated Products',style: TextStyle(fontSize: 16.sp,fontWeight:FontWeight.bold,overflow: TextOverflow.ellipsis)),
...
final String title ;
  ...
  Widget build(BuildContext context) {
    return  Text(title,
        maxLines: 1,
        overflow: TextOverflow.ellipsis, style:  TextStyle(fontSize:14.sp,color: Colors.black54,));
  }
}
