...
class AddressItem extends StatelessWidget {
 const   AddressItem({
    Key? key,  required this.index,  this.isPay = false, required this.selectedIndex ,
  }) : super(key: key);
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
              isPay?Container() : IconButton(onPressed: ()=>MagicRouter. navigateTo( AddAddressView()), icon:  const Icon(Icons.edit_outlined,color: kPrimaryColor,))
              ],
            ),
