...
class _OnBoardingViewState extends State<OnBoardingView> {
  List<OnBoardingModel> boarding = [
    OnBoardingModel(
        ...
        desc: 'E Commerce application template Buy this code template in codecanyon',
            ...
            children: [
              ...
              Expanded(
                child: FloatingActionButton.extended(
                  ...
                  label: currentIndex<boarding.length-1?  Text('Next',style: TextStyle(fontSize: 18.sp)): const Text('Get Started',style: TextStyle(fontSize: 15)),
                ),
              ),
            ],
          )
