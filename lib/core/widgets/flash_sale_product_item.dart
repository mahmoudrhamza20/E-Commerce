                ...
                Stack(
                  ...
                  children: [
                    ...
                    widget.isdecs?  Container(
                      ...
                      child:  Center(child: Text('10%',style: TextStyle(color: Colors.white,fontSize: 14.sp))),
                    ): Container(),
                  ],
                ),
                 SizedBox(height: 8.h,),
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children:  [
                        ...
                        Row(
                          children:   [
                           ...
                           SizedBox(width: 6.w,),
                            const Text('\$250',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough  )),
                          ],
                        ),
                        Row(
                          children:  [
                        ...
                        Row(
                          children:  [
                            Text('7 ',style: TextStyle(color: Colors.black54,fontSize: 12.sp),),
                            Text('Available',style: TextStyle(color: Colors.black54,fontSize: 12.sp),),
                          ],
                        ),
                      ],
                    ),
